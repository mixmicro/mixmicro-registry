...
/**
 * {@link NacosSyncException}
 *
 * <p>Class NacosSyncException Definition
 *
 * @author <a href="mailto:iskp.me@gmail.com">Elve.Xu</a>
 * @version ${project.version} - 2020/11/13
 */
public class NacosSyncException extends RuntimeException {

  /**
   * Constructs a new runtime exception with {@code null} as its detail message. The cause is not
   * initialized, and may subsequently be initialized by a call to {@link #initCause}.
   */
  public NacosSyncException() {}
   ...
   */
  public NacosSyncException(String message) {
    super(message);
  }
   ...
   * @since 1.4
   */
  public NacosSyncException(String message, Throwable cause) {
    super(message, cause);
  }
   ...
   * @since 1.4
   */
  public NacosSyncException(Throwable cause) {
    super(cause);
  }
